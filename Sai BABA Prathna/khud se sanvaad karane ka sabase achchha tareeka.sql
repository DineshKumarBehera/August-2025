...
Given two strings, S and T with respective lengths M and N, your task is to determine the
length of their longest common subsequence.
A subsequence is a sequence that appears in the same relative order, but not necessarily contiguous.
For example, in the string "abc", the subsequences include "", "a", "b", "c", "ab", "bc", "ac", "abc", among others.*/
...
sambodhit ish tarh nahi kijiye : for example:
Kyunki jab aap 'sabse chhota' dhoondhte hain, to aapko hamesha do cheezon ki zaroorat hoti hai

ish tarh kijiye :
Kyunki jab mei 'sabse chhota' dhoondhta hun, to mujhe hamesha do cheezon ki zaroorat hogi